...
import raahee from '../resources/raahee.png'
import msengage from '../resources/microsoft.png'
            ...
            <Row>
				<Col md={3} className="service">
					<div data-aos="fade-right" data-aos-once={true}>
						<img className="icon" src={raahee} height="50px" alt="intuit" />
						<h4>Raahee- SDE Intern</h4>
						<p>
						Working as a React Developer with Web Development Team at Raahee. Worked on building a web calendar to book client appointments with therapists.
						</p>
					</div>
				</Col>
				<Col md={3} className="service border-side-left">
					<div data-aos="fade-down" data-aos-once={true}>
						<img className="icon" src={msengage} height="50px" alt="google" />
						<h4>Microsoft Engage 2021</h4>
						<p>
						Made a clone of Microsoft Teams for the Engage Challenge with features like group video calling, screen sharing, chat, event scheduling on calendar, collaborative whiteboard, voice assistant and many more. Incoming SWE Intern'22 at Microsoft.
						</p>
					</div>
				</Col>
				<Col md={3} className="service border-side-right">
					<div data-aos="fade-down" data-aos-once={true}>
